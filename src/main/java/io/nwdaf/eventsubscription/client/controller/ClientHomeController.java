...
public class ClientHomeController {
    ...
    @GetMapping(value = "/client/notify/{id}")
    @CrossOrigin(origins = "*")
    public ResponseEntity<NnwdafEventsSubscriptionNotification> get(@PathVariable("id") String id) {
        return ResponseEntity.status(HttpStatus.OK).body(currentSubNotifications.get(id));
    }
